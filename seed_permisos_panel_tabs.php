...
$funciones_def = [
    ...
    'polizas' => [
        ...
        ['POLIZAS_CANCELAR_INDIVIDUAL', 'Cancelación Técnica Individual (A Prorrata)', 'editar'],
        ['POLIZAS_CANCELAR_GRUPO',      'Cancelación por Selección (Grupal)', 'editar'],
        ['POLIZAS_CANCELAR_MASIVO',     'Cancelación Masiva Colectiva', 'eliminar'],
    ],
    'cotizaciones' => [
...
$malla = [
    ...
    'POLIZAS_CANCELAR_INDIVIDUAL' => [1, 1, 0, 0, 0, 0, 0, 0],
    'POLIZAS_CANCELAR_GRUPO'      => [1, 1, 0, 0, 0, 0, 0, 0],
    'POLIZAS_CANCELAR_MASIVO'     => [1, 1, 0, 0, 0, 0, 0, 0],
